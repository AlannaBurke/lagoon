...
Check the [Requirements for OpenShift by Lagoon](https://github.com/AlannaBurke/lagoon/tree/2a4b2c722c0161e49dccf4417418de1bf36df157/administering_lagoon/openshift_requirements.md) before continuing.
...
We have now a fully running Lagoon. Now it's time to configure the first project inside of it. Follow the examples in [GraphQL API](https://github.com/AlannaBurke/lagoon/tree/2a4b2c722c0161e49dccf4417418de1bf36df157/administering_lagoon/graphql_api.md)
