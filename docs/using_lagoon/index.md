...
They main file that will be used by Lagoon to understand what should be deployed and many more things. See [Documentation for .lagoon.yml](https://github.com/AlannaBurke/lagoon/tree/08311fea5266dac1185f0f15e57f22f92f012bfb/using_lagoon/lagoon_yml.md)

### `docker-compose.yml`

This file is used by Docker Compose to start you Local Development environment. Lagoon also uses it to understand which of the Services should be deployed, which type and how to build them. This happens via `labels`. See [Documentation for docker-compose.yml](https://github.com/AlannaBurke/lagoon/tree/08311fea5266dac1185f0f15e57f22f92f012bfb/using_lagoon/docker-compose_yml.md)
