...
You can also overwrite the templates only for a specific environment, this is done in the [`.lagoon.yml`](https://github.com/AlannaBurke/lagoon/tree/08311fea5266dac1185f0f15e57f22f92f012bfb/using_lagoon/lagoon_yml.md#environmentsnametypes)
...
You can also overwrite the rollout only for a specific environment, this is done in the [`.lagoon.yml`](https://github.com/AlannaBurke/lagoon/tree/08311fea5266dac1185f0f15e57f22f92f012bfb/using_lagoon/lagoon_yml.md#environmentsnamerollouts)
