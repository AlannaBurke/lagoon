...
You can also overwrite the templates only for a specific environment, this is done in the [`.lagoon.yml`](https://github.com/AlannaBurke/lagoon/tree/e599ced37709612428e920a20bd6f05b04d973a2/using_lagoon/lagoon_yml.md#environmentsnametypes)
...
You can also overwrite the rollout only for a specific environment, this is done in the [`.lagoon.yml`](https://github.com/AlannaBurke/lagoon/tree/e599ced37709612428e920a20bd6f05b04d973a2/using_lagoon/lagoon_yml.md#environmentsnamerollouts)
