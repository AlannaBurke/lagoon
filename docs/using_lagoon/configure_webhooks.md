...
3. Set `Content type` to `application\json`
   ...
   ![Github Webhook Configuration 1](https://github.com/AlannaBurke/lagoon/tree/64bdcc1b79855e5cd7e16f061068edc61f9371b6/images/gh_webhook_1.png)
...
4. Choose which events will trigger your webhook. It is our suggestion that you send `push` and `Pull request` events, and then filter further in the Lagoon configuration of your project.
   ...
   ![Github Webhook Configuration 2](https://github.com/AlannaBurke/lagoon/tree/64bdcc1b79855e5cd7e16f061068edc61f9371b6/images/gh_webhook_2.png)
...
3. Set the `Trigger` for which events will send a notification to Lagoon. It is our suggestion that you send `Push events` and `Merge request events` events, and then filter further in the Lagoon configuration of your project.
   ...
   ![Gitlab Webhook Setup](https://github.com/AlannaBurke/lagoon/tree/64bdcc1b79855e5cd7e16f061068edc61f9371b6/images/gl_webhook_1.png)
...
3. `Choose from a full list of triggers` and select
   ...
   * Pull Request
     ...
     * Declined
       ...
       ![Bitbucket Webhook Setup](https://github.com/AlannaBurke/lagoon/tree/64bdcc1b79855e5cd7e16f061068edc61f9371b6/images/bb_webhook_1.png)
4. `Save`
