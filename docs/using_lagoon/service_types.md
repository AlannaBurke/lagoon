...
This table lists all service types that can be defined via `lagoon.type` within a [`docker-compose.yml` file](https://github.com/AlannaBurke/lagoon/tree/64bdcc1b79855e5cd7e16f061068edc61f9371b6/using_lagoon/docker-compose_yml.md)
