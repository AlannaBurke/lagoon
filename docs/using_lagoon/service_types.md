...
This table lists all service types that can be defined via `lagoon.type` within a [`docker-compose.yml` file](https://github.com/AlannaBurke/lagoon/tree/e599ced37709612428e920a20bd6f05b04d973a2/using_lagoon/docker-compose_yml.md)
